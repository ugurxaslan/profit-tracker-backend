...
public interface OpenPositionRepository extends JpaRepository<OpenPosition, Long> {
    ...
    Page<OpenPosition> findByWalletAsset_Wallet_IdAndAsset_IsCashFalse(Long walletId, Pageable pageable);

    Page<OpenPosition> findByWalletAsset_IdAndAsset_IsCashFalse(Long walletAssetId, Pageable pageable);
